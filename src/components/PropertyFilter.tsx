      ...
      <div className="container mx-auto max-w-5xl">
        <div className="relative bg-card rounded-[2.5rem] shadow-[0_25px_60px_-20px_rgba(15,23,42,0.25)] p-6 md:p-10 overflow-hidden">
          ...
          <div className="relative flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5 mb-7">
            <div>
              <p className="text-[10px] font-semibold tracking-[0.28em] text-gold uppercase mb-2">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-3 md:gap-4">
            ...
            <div className="lg:col-span-7 group">
              ...
              <div className="flex items-stretch rounded-2xl border border-border bg-background/40 transition-all duration-300 focus-within:border-cobalt focus-within:bg-background focus-within:shadow-[0_10px_30px_-12px_rgba(15,23,42,0.25),0_0_0_4px_rgba(184,134,11,0.08)] hover:border-cobalt/30">
                {/* Estado */}
            ...
            <div className="lg:col-span-5">
              ...
              <Popover open={typeOpen} onOpenChange={setTypeOpen}>
                <PopoverTrigger asChild>
                  <button
                    type="button"
                    className={`w-full flex items-center gap-3 px-5 py-3.5 rounded-2xl border bg-background/40 text-left transition-all duration-300 hover:border-cobalt/30 ${
                      typeOpen
                ...
                <PopoverContent
                  align="end"
                  sideOffset={8}
                  className="w-[min(20rem,calc(100vw-2rem))] p-2 rounded-2xl border-border shadow-[0_20px_50px_-15px_rgba(15,23,42,0.3)]"
                >
                  <button
                    type="button"
                    onClick={() => {
            ...
            <div className="lg:col-span-8">
              ...
              <div className="flex items-center gap-3 px-5 py-3.5 rounded-2xl border border-border bg-background/40 transition-all duration-300 focus-within:border-cobalt focus-within:bg-background focus-within:shadow-[0_10px_30px_-12px_rgba(15,23,42,0.25),0_0_0_4px_rgba(184,134,11,0.08)] hover:border-cobalt/30">
            ...
            <div className="lg:col-span-4 flex">
              <button
                ...
                className="group relative w-full mt-0 lg:mt-[26px] flex items-center justify-center gap-3 bg-cobalt text-primary-foreground font-semibold text-sm rounded-2xl px-6 py-4 overflow-hidden transition-all duration-300 hover:shadow-[0_20px_40px_-10px_rgba(15,23,42,0.5)] active:scale-[0.98]"
              >
                {/* Gold sweep on hover */}
                <span
                  aria-hidden="true"
...
const FieldLabel = ({ children }: { children: React.ReactNode }) => (
  <label className="block mb-2 text-[10px] font-bold tracking-[0.22em] uppercase text-foreground/50">
    {children}
  </label>
);
